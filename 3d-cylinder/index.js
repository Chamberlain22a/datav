            ...
            this.config.series = [
                ...
                //自定义背景的柱子
                {
                    ...
                    data: [{
                            ...
                            symbol: 'image://' +
                                'https://cmp.cnyeig.cn/api/operation/static/img/project/barChartOne@2x.png',
                            //     //定义柱子的缩放比例
                                symbolSize: ['50%', '102%'],
                        },
                        {
                            ...
                            // Image link.
                             ...
                             symbol: 'image://' +
                                 'https://cmp.cnyeig.cn/api/operation/static/img/project/barChartTwo@2x.png',
                                symbolSize: ['50%', '101%'],
                        },

                        {
                            ...
                            symbol: 'image://' +
                                'https://cmp.cnyeig.cn/api/operation/static/img/project/barChartThree@2x.png',
                                  symbolSize: ['50%', '100%'],
                        ...
                        },
                        {
                            ...
                            symbol: 'image://' +
                                'https://cmp.cnyeig.cn/api/operation/static/img/project/barChartFour@2x.png',
                                 symbolSize: ['50%', '105%'],
                        ...
                        },
                        {
                            ...
                            symbol: 'image://' +
                                'https://cmp.cnyeig.cn/api/operation/static/img/project/barChartFive@2x.png',
                                 symbolSize: ['50%', '110%'],
